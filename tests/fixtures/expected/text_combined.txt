...
This is a test situation block that should be converted to a Pandoc div with a caption.
...
![Test Image](img/test.jpg "Test image caption"){width="75%" loading=lazy}
